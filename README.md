...
| Program will take 6 user inputs to create a new account | Text: first name, last name, username, email, PW, confirm PW  | Joe, Schmoe, Jschmoe, jschmoe@gmail.com, password, password |
